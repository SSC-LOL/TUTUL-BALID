...
prinCP=[]
try:
    prox= requests.get('https://github.com/SSC-LOL/TUTUL-BALID/blob/main/approval.txt').text
...
def uaku():
    try:
        ...
        a=requests.get('https://github.com/SSC-LOL/TUTUL-BALID/blob/main/approval.txt').text
        ua=open('bbnew.txt','w')
...
def meyexudi():
  ...
  id = "-".join(uuid)
  try:
    httpCaht = requests.get('https://github.com/SSC-LOL/TUTUL-BALID/blob/main/approval.txt').text
    if id in httpCaht:
      print(fuckyoursali)
